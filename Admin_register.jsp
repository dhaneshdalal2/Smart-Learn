                    ...
                    <div class="ml-auto w-25">
                        <nav
                            ...
                            <ul
                                ...
                                <li class="cta"><a href="Admin_login.jsp"
									class="nav-link"><span>Login </span></a></li>
                                <li class="cta"><a
									href="Admin_register.jsp" class="nav-link"><span>Registration</span></a></li>
                            </ul>
                        </nav>
                        <a href="#"
                                    ...
                                    <div
                                        ...
                                        <div class="card"
                                            ...
                                            <div class="card-body p-5">
                                                <h2
													class="text-uppercase text-center mb-5 black-text">Create an account
                                                </h2>

                                                <form
													action="Admin_register_Ctrl" method="post">
                                               <div
														class="form-outline mb-4">
                                                        <label
															class="form-label" for="form3Example1cg">Your
                                                            ID</label>
                                                        <input
															type="text" id="form3Example1cg"
															class="form-control form-control-lg"
															placeholder="Enter your ID(NUMBER)" name="A_id" />
                                                    ...
                                                    <div
                                                        ...
                                                        <input
																type="text" id="form3Example1cg"
																class="form-control form-control-lg"
																placeholder="Enter your Name" name="A_name" />
                                                    ...
                                                    <div
                                                        ...
                                                        <input
																...
																class="form-control form-control-lg"
																placeholder="Enter your Email" name="A_email" />
                                                    ...
                                                    <div
                                                        ...
                                                        <input
																...
																class="form-control form-control-lg"
																placeholder="Create New Password" name="A_password" />
                                                    ...
                                                    <div
															class="form-outline mb-4">
                                                        <label
																class="form-label" for="form3Example4cdg">Contact
                                                            Number</label>
                                                        <input
																type="text" id="form3Example4cdg"
																class="form-control form-control-lg"
																placeholder="Enter your Contact Number" name="A_contact" />

                                                    </div>
                                                    <div
															class="form-outline mb-4">
                                                        <label
																class="form-label" for="form3Example4cdg">Address
                                                            Number</label>
                                                        <input
																type="text" id="form3Example4cdg"
																class="form-control form-control-lg"
																placeholder="Enter your City" name="A_address" />

                                                    </div>

                                                    <div
															class="form-check d-flex justify-content mb-5">
                                                        <label
																class="form-check-label" for="form2Example3g">
                                                    ...
                                                    <p
                                                        ...
                                                        <a
																href="Login.jsp" class="fw-bold text-body"><u>Login
                                                                here</u></a>
                                                    </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 ml-auto text-center">
                        ...
                        <!-- Github -->
                        <li><svg xmlns="http://www.w3.org/2000/svg"
									width="26" height="26" fill="currentColor" class="bi bi-github"
									viewBox="0 0 16 16">
                                <path
